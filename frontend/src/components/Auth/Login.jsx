...
import { Eye, EyeOff, Smartphone, User, Lock, ArrowLeft } from 'lucide-react';
      ...
      >
        ...
        <motion.button
          onClick={() => {
            ...
            // Clear any potential authentication state
          ...
          whileTap={{ scale: 0.95 }}
          className="flex items-center text-dark-400 hover:text-white transition-colors mb-6"
        >
